...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_email'])) {
	...
	if (isset($_POST['book_id'])          &&
        ...
        $text = "Book title";
        $location = "../../container/book/edit-book.php";
        $ms = "id=$id&error";
          ...
          if (!empty($_FILES['book_cover']['name'])) {
		      if (!empty($_FILES['file']['name'])) {
		        ...
		        if ($book_cover['status'] == "error" || 
			    	...
			    	$em = $book_cover['data'];
			    	header("Location: ../../container/book/edit-book.php?error=$em&id=$id");
			    	exit;
			    }else {
		           ...
		           $book_cover_URL = $book_cover['data'];
					...
					$res  = $stmt->execute([$title, $author, $description, $category,$book_cover_URL, $file_URL, $id]);
				     if ($res) {
						...
						header("Location: ../../container/book/edit-book.php?success=$sm&id=$id");
			            exit;
				     }else{
