...
if (isset($_SESSION['user_id']) &&
    ...
    include "../validation/func-validation.php";
    include "../file/func-file-upload.php";
	if (isset($_POST['book_title'])       &&
        ...
        $text = "Book title";
        $location = "../../container/book/add-book.php";
        $ms = "error";
	    ...
	    if ($book_cover['status'] == "error") {
	    	$em = $book_cover['data'];
	    	header("Location: ../../container/book/add-book.php?error=$em&$user_input");
	    	exit;
	    }else {
		    ...
		    if ($file['status'] == "error") {
		     ...
		     if ($res) {
				...
				header("Location: ../../container/book/add-book.php?success=$sm");
	            exit;
		     }else{
		     	$em = "Unknown Error Occurred!";
				header("Location: ../../container/book/add-book.php?error=$em");
	            exit;
		     }
		    }
	    }
